...
class SMTPTutorialClient(smtp.ESMTPClient):
    mailFrom = "kebenson@gmail.com"
    mailTo = "kebenson@gmail.com"
    mailData = '''\
...
class SMTPClientFactory(protocol.ClientFactory):
    ...
    def buildProtocol(self, addr):
        return self.protocol(secret=None, identity='gmail.com')
...
getMailExchange('gmail.com').addCallback(cbMailExchange)
